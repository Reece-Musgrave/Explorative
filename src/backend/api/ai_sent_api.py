...
@router.post("/api/v1/ai/sentiment-analysis/db")
...
@router.get("/api/v1/ai/sentiment-analysis/{show}/{season}/{episode}")
...
@router.get("/api/v1/ai/reviews/{show}/{season}/{episode}")
