...
@router.post("/api/v1/ai/sentiment-analysis/db", response_model=MessageResponse)
...
@router.get("/api/v1/ai/reviews/{show}/{season}/{episode}", response_model=SentimentCreate)
